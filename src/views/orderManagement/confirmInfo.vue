    ...
    <div class="app-container">
        ...
        <el-row class="bottom">
         ...
         <el-row class="bottom">
           ...
           <el-col :span="12" class="bottom" style="float:right">
               <el-col :span="6">
           ...
           <el-col :span="12" style="float:right" class="bottom">
               <el-col :span="6">
        ...
        <el-row class="bottom">
           <el-col :span="12">
               <el-col :span="6">
                   <span class="title-name">买家芝麻分</span>
               </el-col>
               <el-col :span="8">
                   <span class="title-name"></span>
               </el-col>
         ...
         <el-row class="bottom">
           <el-col :span="12">
               <el-col :span="6">
                   <span class="title-name">风险系数</span>
               </el-col>
               <el-col :span="8">
                    <span class="title-name"></span>
               </el-col>
        ...
        <el-row class="bottom">
           <el-col :span="12">
               <el-col :span="6">
                   <span class="title-name">风险明细</span>
               </el-col>
         ...
         <el-row class="bottom">
           <el-col :span="12">
               <el-col :span="3">
                   <span class="title-name">审核人</span>
               </el-col>
               <el-col :span="5">
                   <span class="title-name"></span>
               </el-col>
        ...
        <el-row class="bottom">
           ...
           <el-col :span="3">
               <el-button size="small" @click="Refused()">拒绝</el-button>
           </el-col>
        </el-row>
    </div>
</template>
        ...
        Refused(){
            var data = {
                   order_id:1,
                    ...
                    this.$axios.post('/order/refuse',data).then(res=>{
                    console.log(res.data)
                }).catch(err=>{console.log(err)})
        }
    },
