<template>
    ...
    <el-table :data="tableList" v-loading="listLoading" border element-loading-text="拼命加载中" style="width: 100%;">
        <el-table-column prop="uid" align="center" label="分类名称">
        </el-table-column>
      <el-table-column prop="number" align="center" label="排序值">
      </el-table-column>
      <el-table-column prop="date" align="center" label="创建时间" @click="go">
      </el-table-column>
      <el-table-column prop="title" align="center" label="页面显示" >
      </el-table-column>
